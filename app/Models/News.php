...
class News extends Model
{
    ...
    protected $fillable=['title','feature_photo','feature_medium','feature_small','meta_description','description','topic','photo_caption','video_url','published_status','published_date', 'show_at_homepage','is_cover_news','category_id','sub_cat_id','news_author_id','division_id','district_id','created_by','updated_by'];
